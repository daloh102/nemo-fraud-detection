...
# Dein optimierter System Prompt
...
4. Die Gespräche sollen natürlich wirken:
- unterschiedliche Gesprächslängen
- Nachfragen
- Unterbrechungen
- höfliche oder emotionale Sprache
...
async def generate_single_sample(index: int, f_data, f_bench):
    ...
    async x = semaphore  # Platzhalter für Logik, direkt weiter unten mit with semaphore:
        ...
        for attempt in range(3):
            try:
                ...
                async with file_lock:
                    ...
                    # Benchmark-Datei aus den generierten Labels füttern
...
if __name__ == "__main__":
    asyncio.run(main())i in range(1, NUM_SAMPLES + 1)]
        await asyncio.gather(*tasks)
